...
try:
    ...
    #If forgot to initialize submodules
...
default_run = 'pretrained_model'
weights_url = ("https://pan.baidu.com/s/1Y7DeaYIZ-IMT2UlY9NkaeQ")
...
def maybe_download_and_extract(runs_dir):
    ...
    logging.info("Extracting model_pretrained.zip")
...
def main(_):
    ...
    if FLAGS.logdir is None:
        # Download and use weights from the pretrained_model
